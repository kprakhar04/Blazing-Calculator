...
const Desc = 'If Possible Take Out Common Of All Elements';
    ...
    try {
        ...
        if (casecheck(dim, '1D')) {
            if (casecheck(type, TO_CALCULATE)) {
                ...
                return [
                    {
                        Name: "Transformation Matrix", Value: result, Desc
                    }
                ];
            }
            else {
                ...
                return [
                    {
                        Name: "Reconstructed Matrix", Value: result, Desc
                    }
                ];
            }
        }
...
export const klTransform = (input, rows, cols, type) => {
    try {
        ...
        return [
            {
                Name: "Covariance Matrix", Value: covarianceMat, Desc: ''
            },
            {
